/* ═══════════════════════════════════════════════════════════════
   CENTRALIZED LOADER STATE MANAGER
   ═══════════════════════════════════════════════════════════════
   Manages all loading states across the application.
   Provides a single, unified loading indicator that can be triggered
   from any API call or async operation.
*/
...
const LoaderManager = (() => {
     ...
     return {
          ...
          /**
           * Auto-wrap API calls
           * Usage: LoaderManager.withLoader(Api.getPortfolio, 'Fetching portfolio...')
           */
          withLoader(apiMethod, loadingText = 'Loading...') {
               return LoaderManager.wrap(() => apiMethod(), loadingText);
          },
     };
})();
